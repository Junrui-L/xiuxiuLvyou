    ...
    <div class="custom-info">
      <div class="info-wrapper">
        ...
        <ul class="info-list">
          ...
          <li class="info-item">游玩时间 <span class="fr">{{callData.godate}}至2017-11-25</span></li>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      amqHander(){
        // let amq = org.activemq;
        // var myDestination = '.xxxx'
        // console.log(org.activemq.AmqAdapter);
