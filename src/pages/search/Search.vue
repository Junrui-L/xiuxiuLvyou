<template>
    <div class="Search" >
        <div class="header">
            ...
            <!--<input type="text" placeholder="请尝试北京" class="search-input"/>-->
        </div>
        <!-- 切换按钮 -->
        ...
        <div class="area_content"  v-if="changeShowType == 'area'">
            <div class="menu_container">
                <section class="area_left wrapper_menu" id="wrapper_menu"  ref="wrapperMenu">
                    <ul class="menu-wrap">
                        <li v-for="(item, index) in areaList" :key="index" :class="{active_ia: index == menuIndex}" @click="chooseMenu(index)" >
                            <!--<li class='active_ia'>-->
                            {{ item.name }}
                        </li>
                    </ul>
            ...
            <div class="menu_container">
                ...
                <section class="area_right" ref="menuList">
                    <ul class="area-menu">
                        <li class="area-wrapper" >
                            <!--<div v-if="index==0">-->
                                <!--<section class="sub-cate">-->
                                    <!--<h3 class="sub_title">定位</h3>-->
                                    <!--<span>深圳</span>-->
                                <!--</section>-->
                                <!--<section class="sub-cate">-->
                                    <!--<h3 class="sub_title">历史</h3>-->
                                    <!--<ul class="search-history clearfix">-->
                                        <!--<li class="his-item fl">凤凰</li>-->
                                        <!--<li class="his-item fl">凤凰</li>-->
                                        <!--<li class="his-item fl">北京</li>-->
                                        <!--<li class="his-item fl">南京</li>-->
                                        <!--<li class="his-item fl">天津</li>-->
                                    <!--</ul>-->
                                <!--</section>-->
