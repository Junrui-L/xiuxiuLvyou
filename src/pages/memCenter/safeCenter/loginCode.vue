<template>
  <div class="loginCode">
    ...
    <div class="input-wrapper opwd">
      <input type="password" v-model="tradePwd" class="input-txt" maxlength="8" placeholder="请输入登陆蜜码"
             name="loginPwd">
    </div>
    <div class="input-wrapper">
      <input type="password" v-model="multradePwd" class="input-txt" maxlength="8" placeholder="再次输入登陆蜜码"
             name="tradePwd">
    </div>
  </div>
</template>
